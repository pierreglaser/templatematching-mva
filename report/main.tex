...
en faisant varier les valeurs de $\mu$ et $\lambda$. Les résulats sont visibles en \ref{fig:param}. Cette courbe permet de bien rendre 
...
le modèle demontre une précision assez bonne de 81 \%, ce qui est en lien avec la valeur précédemment observée pour 10 pixels. Dés que le rayon dépasse 
15 pixels, la précision du modèole stagne. Ceci laisse apercevoir que 10\% des détections sont abhérantes.

\begin{figure}[htpb]
    \centering
        \includegraphics[scale=0.7]{plots/parameter_score_C_D_lin_R2.jpg}
        \caption{Influence des paramètres de régularisation}%
...
\begin{figure}[htpb]
        ...
        \centering 
        \includegraphics[scale=0.7]{plots/radius_scores.jpg}
